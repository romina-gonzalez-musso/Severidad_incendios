...
Más sencillo, la [función](https://github.com/romina-gonzalez-musso/Severidad_incendios/blob/main/R_Functions/Procesar_incendio.R) debe estar descargada en el directorio de trabajo y solo se le deben indicar los parámetros: 
