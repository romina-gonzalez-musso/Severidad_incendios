...
El **dNBR (.tif)** obtenido con GEE se procesa en R para generar el
**perímetro del incendio**, calcular la **superficie total afectada** y
la **superficie por las clases de severidad** de
...
y puede ser útil para comprender cómo se obtiene el área quemada.

Las funciones de este repositorio tienen actualizaciones y mejoras 🚀✨

------------------------------------------------------------------------

### **Opción 1 (más sencilla): usando la función `Procesar_incendio`**
...
Sups <- procesar_incendio(nbr_dir = nbr_dir,        # Indicar el directorio donde está en dNBR.tif
                          ...
                          poligono = poligono,      # Polígono que delimita el área que se va a procesar. Formato .shp
